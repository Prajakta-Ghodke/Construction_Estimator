	...
	<table class="table table-bordered">
		...
		<tbody  style="border: 3px solid black">
			...
			<tr  style="border: 3px solid black">
				...
				<td style="border: 2px solid black"><a href="edit.php?id=<?php echo $row['id'];?>" class="btn btn-success">Edit</a></td>
				<td style="border: 2px solid black"><a href="delete.php?id=<?php echo $row['id'];?>" class="btn btn-danger" onclick="return confirm('Are you sure?')">Delete</a></td>
			</tr>
		</tbody>
		<?php 
				$count++;}
